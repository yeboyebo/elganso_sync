...
class EgIdlEcommerce(DefaultSerializer):
    ...
    def get_data(self):
        ...
        if "country" in self.init_data["pickup_address"]:
            if str(self.init_data["pickup_address"]["country"]) == "ES":
                if id_region:
                    esProvinciaFactura = qsatype.FLUtil.sqlSelect("provincias", "imprimirfactura", "mg_idprovincia = " + id_region)
