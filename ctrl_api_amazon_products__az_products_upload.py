...
class AzProductsUpload(AzFeedsUpload, ABC):
    ...
    def get_query(self):
        ...
        q.setWhere("lsc.id IN (SELECT id FROM lineassincro_catalogo WHERE tiposincro = 'Enviar productos' AND NOT sincronizado AND website = 'AMAZON' LIMIT {}) AND aa.talla <> '35'".format(self.driver.azQueryLimit))
