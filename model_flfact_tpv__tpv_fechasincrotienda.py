...
# @class_declaration elganso_sync_tpv_fechasincrotienda #
class elganso_sync_tpv_fechasincrotienda(interna_tpv_fechasincrotienda, helpers.MixinConAcciones):
    pass
...
class tpv_fechasincrotienda(elganso_sync_tpv_fechasincrotienda, helpers.MixinConAcciones):
    pass
