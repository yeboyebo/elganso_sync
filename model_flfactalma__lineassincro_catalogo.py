...
# @class_declaration elganso_sync_lineassincro_catalogo #
class elganso_sync_lineassincro_catalogo(interna_lineassincro_catalogo, helpers.MixinConAcciones):
    pass
...
class lineassincro_catalogo(elganso_sync_lineassincro_catalogo, helpers.MixinConAcciones):
    pass
