...
class AzImageBackgroundUpload(UploadSync, ABC):
    ...
    def get_query(self):
        ...
        q.setWhere("az.articulocreado AND NOT az.sincroimagenes AND NOT az.errorsincro AND urls.urls IS NOT NULL AND urls.urls <> '' AND urls.urls <> ' ' AND (urls.urls_sinfondo IS NULL OR urls.urls_sinfondo = '') LIMIT 1")
