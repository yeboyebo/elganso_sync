...
# @class_declaration elganso_sync_atributosarticulos #
class elganso_sync_atributosarticulos(interna_atributosarticulos, helpers.MixinConAcciones):
    pass
...
class atributosarticulos(elganso_sync_atributosarticulos, helpers.MixinConAcciones):
    pass
