...
# @class_declaration elganso_sync_movistock #
class elganso_sync_movistock(interna_movistock, helpers.MixinConAcciones):
    pass
...
class movistock(elganso_sync_movistock, helpers.MixinConAcciones):
    pass
