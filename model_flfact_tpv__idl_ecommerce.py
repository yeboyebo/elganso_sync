...
# @class_declaration elganso_sync_idl_ecommerce #
class elganso_sync_idl_ecommerce(interna_idl_ecommerce, helpers.MixinConAcciones):
    pass
...
class idl_ecommerce(elganso_sync_idl_ecommerce, helpers.MixinConAcciones):
    pass
