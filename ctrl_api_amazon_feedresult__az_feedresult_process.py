...
class AzFeedResultProcess(DownloadSync, ABC):
    ...
    def get_query(self):
        ...
        q.setWhere("procesadoaz AND NOT procesadoaq AND tipo NOT IN ('OrderAcknowledgement', 'OrderFulfillment','Inventory','Price') ORDER BY fecha, hora LIMIT 1")
    ...
    def after_sync(self, response_data=None):
        ...
        self.log("Exito", "Resultados procesados correctamente (ids_amazon: {})".format([str(self.procesamientos[idlog]['idamazon']) for idlog in self.procesamientos]))
