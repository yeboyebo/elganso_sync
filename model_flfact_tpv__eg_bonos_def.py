...
class elganso_sync(interna):
    ...
    def elganso_sync_generarcuponespromocion(self, params):
        try:
            ...
            if "passwd" in params and params['passwd'] == self.params['auth']:
                if "descuento" not in params or "email" not in params or "dtopor" not in params or "activo" not in params or "promo" not in params or "diasexpiracion" not in params:
                ...
                activo = params['activo']
                diasExpiracion = params['diasexpiracion']
                dtoPor = params['dtopor']
                cuponMagento = params['promo']
                articulosDto = ""
                aArtregalo = ""
